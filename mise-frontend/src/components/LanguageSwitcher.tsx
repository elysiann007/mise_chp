...
export default function LanguageSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full mt-2 end-0 bg-zinc-900 border border-zinc-700 rounded-xl overflow-hidden shadow-2xl shadow-black/50 z-50 min-w-[140px]">
          {LANGS.map(lang => (
            <button
              key={lang.code}
            ...
            >
              ...
              {lang.code === i18n.language && <span className="ms-auto text-amber-400 text-xs">✓</span>}
            </button>
          ))}
        </div>
      )}

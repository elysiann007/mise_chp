    ...
    <PageWrapper>
      <main className="min-h-screen bg-stone-950 pt-20">
        ...
        <div className="max-w-3xl mx-auto px-5 py-16 space-y-20">
          ...
          <motion.div variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }} className="border-t border-zinc-800/60 pt-8 text-center">
            <p className="text-zinc-700 text-xs leading-relaxed">{t('drinks.disclaimer')}</p>
          </motion.div>
        </div>
      </main>
    </PageWrapper>
